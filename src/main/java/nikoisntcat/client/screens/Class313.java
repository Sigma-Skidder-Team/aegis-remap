...
public class Class313 {
    ...
    public void method1971(DrawContext context, int x, int y, int width, int mouseX, int mouseY) {
        ...
        if (BoundaryUtils.inBoundary(mouseX, mouseY, x, y + 1, x + width, y + 9)) {
    ...
    public boolean method1972(double mouseX, double mouseY, int button) {
        if (BoundaryUtils.inBoundary(mouseX, mouseY, this.field2393, this.field2397 + 1, this.field2393 + this.field2395, this.field2397 + 9)) {
            return true;
        }
